...
const Notification = () => {
  ...
  const { notification, userChats, allUsers, markAllNotificationAdRead, markNotificationAsRead } =
        ...
        <div className="notifications-box">
          <div className="notifications-header">
            ...
            <div
              ...
              onClick={() => markAllNotificationAdRead(notification)}
            >
              Mark all as read
            </div>
          </div>
          {modifiedNotifications?.length === 0 ? (
            <span className="notificatipn">No notification yet..</span>
          ) : null}
