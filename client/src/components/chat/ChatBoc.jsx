    ...
    return (
        <Stack gap={4} className="chat-box">
            ...
            <Stack direction="horizontal" gap={3} className="chat-input flex-grow-0">
                ...
                <button className="send-btn" onClick={() => sendTextMessage(textMessage, user, currentChat._id, setTextMessage)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-send-fill" viewBox="0 0 16 16">
